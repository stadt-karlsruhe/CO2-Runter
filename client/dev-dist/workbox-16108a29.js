        ...
        async _getResponse(handler, request, event) {
            ...
            try {
                ...
                if (!response) {
                    ...
                    logger.log(
                        `While responding to '${getFriendlyURL(
                            request.url
                        )}', ` +
                            `an ${
        ...
        constructor(precacheController, options) {
            const match = ({ request }) => {
                ...
                for (const possibleURL of generateURLVariations(
                    ...
                    if (cacheKey) {
                        const integrity =
                            precacheController.getIntegrityForCacheKey(
                                cacheKey
                            );
                        return {
                            cacheKey,
    ...
    */
    ...
    class NavigationRoute extends Route {
        ...
        _match({ url, request }) {
            ...
            if (
                this._allowlist.some((regExp) => regExp.test(pathnameAndSearch))
            ) {
                {
                    logger.debug(
